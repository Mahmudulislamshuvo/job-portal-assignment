    ...
    <>
      <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
          ...
          <div>
            <h3 class="font-semibold text-sm mb-1">Thousands of Jobs</h3>
        ...
        <div class="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
          ...
          <div>
            <h3 class="font-semibold text-sm mb-1">Job Alerts</h3>
            <p class="text-xs text-muted-foreground">
        ...
        <div class="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
          ...
          <div>
            <h3 class="font-semibold text-sm mb-1">Secure & Private</h3>
            <p class="text-xs text-muted-foreground">
